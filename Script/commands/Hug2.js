...
module.exports.run = async function ({ event, api, args }) {
  ...
  if (event.type === "message_reply") {
    ...
    // No target specified
    return api.sendMessage("❌আপনার পছন্দের মানুষটিকে ম্যানশন করুন😘", threadID, messageID);
  }
  ...
  if (targetID === senderID) {
    return api.sendMessage("😕নিজেকে কীভাবে hug করবি😐??", threadID, messageID);
  }
  ...
  try {
    ...
    console.error(e);
    return api.sendMessage("❌ছবিটি তৈরি করতে সমস্যা হচ্ছে", threadID, messageID);
  }
};
